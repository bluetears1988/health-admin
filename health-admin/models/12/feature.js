...
class Ctrl{
	 ...
	 */
	routes() {
		this.app.get('/api/feature', this.getAll.bind(this))
		// this.app.get('/api/card/:id', this.get.bind(this))
		this.app.post('/api/feature', this.post.bind(this))
		this.app.put('/api/feature/:id', this.put.bind(this))
		this.app.delete('/api/feature/:id', this.delete.bind(this))
